...
//Carlos Parada 2013-12-03 Not Record Weight Class
/*
import org.spin.grid.VRecordWeightGetWeightUI;
...
public class VCreateFromFactory
{
	...
	public static ICreateFrom create (GridTab mTab)
	{
		...
		//Carlos Parada 2013-12-03 Not Record Weight Class
		/*if(AD_Table_ID == I_FTA_RecordWeight.Table_ID)
			cl = VRecordWeightGetWeightUI.class;*/
		//End Carlos Parada
		if (cl != null)
		{
			try
