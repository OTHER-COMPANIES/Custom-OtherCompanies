...
public class MStorage extends X_M_Storage
{
		...
		BigDecimal diffQtyReserved, BigDecimal diffQtyOrdered, String trxName)
	{
		...
		if (diffQtyReserved != null && diffQtyReserved.signum() != 0)
		{
			if (storage0 == null)
			{
				...
				Util.assume(storage.getQtyReserved().signum() >= 0, Msg.translate(ctx, "QtyReservedShouldBe0") + " " +  storage.getMsg());
			}
			else
			{
				storage0.setQtyReserved(storage0.getQtyReserved().add(diffQtyReserved));
				Util.assume(storage0.getQtyReserved().signum() >= 0, Msg.translate(ctx, "QtyReservedShouldBe0") + " " + storage0.getMsg());
			}
	...
	public String getMsg()
	{
		...
		StringBuffer sb = new StringBuffer("@M_Warehouse_ID@=").append(warehouse.getValue() + " - " + warehouse.getName())
				.append("\n@M_Locator_ID@=").append(locator.getValue())
					.append("\n@M_Product_ID@=").append(product.getValue() + " - " + product.getName())
					.append("\n@M_AttributeSetInstance_ID@=").append(getM_AttributeSetInstance_ID())
			.append("\n@QtyOnHand@=").append(getQtyOnHand())
			.append("\n@QtyReserved@=").append(getQtyReserved())
			.append("\n@QtyOrdered@=").append(getQtyOrdered());
