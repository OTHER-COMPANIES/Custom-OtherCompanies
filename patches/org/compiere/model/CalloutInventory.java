...
public class CalloutInventory extends CalloutEngine
{
	 ...
	 * @return
	 */
	public String productByLocator (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		if (isCalloutActive())
			return "";
		Integer M_Product_ID = (Integer)mTab.getValue("M_Product_ID");
		...
		if (M_Product_ID != null) {
			...
			M_Locator_ID = MStorage.getM_Locator_ID(M_Warehouse_ID, M_Product_ID, 
					M_AttributeSetInstance_ID, QtyInternalUse, null);
